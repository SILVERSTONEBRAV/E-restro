    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <div class="input-group">
                    <input class="form-control" type="text" placeholder="Search product by name and price " title="Search product by name price" aria-describedby="btnNavbarSearch" name="searchkey" />
