  ...
  if (empty($_POST["pay_code"]) || empty($_POST["pay_amt"]) || empty($_POST['pay_method'])) {
    ...
    $pay_Code = $_POST['pay_code'];
      ...
      else
      {
          ...
          $postQuery = "INSERT INTO m_payments (pay_id, pay_code, order_code, customer_id, pay_amt, pay_method) VALUES(?,?,?,?,?,?)";
          $upQry = "UPDATE m_orders SET order_status =? WHERE order_code =?";
              ...
              <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="number" name="phone" required minlength="10" class="form-control">
                  </div>
                  <div class="col-md-6">
                    <label>Delivery Address</label>
                    <input type="text" name="address" required placeholder="e.g Eldoret, moi university, stage" class="form-control">
                  </div>
                  <div class="col-md-6">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="pay" value="Pay Order" class="btn btn-success" value=""> Or
                    <input type="submit" name="pay" value="M-pesa" class="btn btn-success" value="" onclick="redirectToMpesaPage()"> Or
                    <input type="submit" name="paypal" value="Paypal" class="btn btn-success" value=""> 
                  </div>
                </div>
              </form>
            </div>
