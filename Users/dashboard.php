            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  $ret = "SELECT * FROM  m_orders WHERE customer_id = '$customer_id' ORDER BY `m_orders`.`created_at` DESC LIMIT 10 ";
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM   m_payments WHERE customer_id ='$customer_id'   ORDER BY `m_payments`.`created_at` DESC LIMIT 10 ";
                  $stmt = $mysqli->prepare($ret);
                  $stmt->execute();
                  $res = $stmt->get_result();
