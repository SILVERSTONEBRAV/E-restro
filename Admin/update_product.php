...
if (isset($_POST['UpdateProduct'])) {
  ...
  if (empty($_POST["prod_code"]) || empty($_POST["prod_name"]) || empty($_POST['prod_desc']) || empty($_POST['prod_price']) || empty($_POST['prod_discount'])) {
    ...
    $postQuery = "UPDATE m_products SET prod_code =?, prod_name =?, prod_img =?, prod_desc =?, prod_price =?, prod_discount =? WHERE prod_id = ?";
    $postStmt = $mysqli->prepare($postQuery);
    //bind paramaters
    $rc = $postStmt->bind_param('sssssss', $prod_code, $prod_name, $prod_img, $prod_desc, $prod_price, $prod_discount, $update);
    $postStmt->execute();
...
<body>
  ...
  <div class="main-content">
    ...
    $update = $_GET['update'];
    $ret = "SELECT * FROM  m_products WHERE prod_id = '$update' ";
                ...
                <form method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="prod_discount" class="form-control" value="<?php echo $prod->prod_discount; ?>">
                    </div>
                  </div>
                  <hr>
                  <div class="form-row">
