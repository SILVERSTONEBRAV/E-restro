...
if (isset($_POST['addProduct'])) {
  ...
  if (empty($_POST["prod_code"]) || empty($_POST["prod_name"]) || empty($_POST['prod_desc']) || empty($_POST['prod_price'])|| empty($_POST['prod_discount'])) {
    ...
    move_uploaded_file($_FILES["prod_img"]["tmp_name"], "assets/images/products/" . $_FILES["prod_img"]["name"]);
    $prod_desc = $_POST['prod_desc'];
    $prod_price = $_POST['prod_price'];
    $prod_discount = $_POST['prod_discount'];
	
    //Insert Captured information to a database table
    $postQuery = "INSERT INTO m_products (prod_id, prod_code, prod_name, prod_img, prod_desc, prod_price, prod_discount ) VALUES(?,?,?,?,?,?,?)";
    $postStmt = $mysqli->prepare($postQuery);
    //bind paramaters
    $rc = $postStmt->bind_param('sssssss', $prod_id, $prod_code, $prod_name, $prod_img, $prod_desc, $prod_price, $prod_discount);
    $postStmt->execute();
              ...
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="prod_discount" class="form-control" value="">
                  </div>
                </div>
                <hr>
                <div class="form-row">
