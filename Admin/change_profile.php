...
if (isset($_POST['ChangeProfile'])) {
  ...
  $Qry = "UPDATE m_admin SET admin_name =?, admin_email =? WHERE admin_id =?";
...
if (isset($_POST['changePassword'])) {
  ...
  if (!$error) {
    $admin_id = $_SESSION['admin_id'];
    $sql = "SELECT * FROM m_admin   WHERE admin_id = '$admin_id'";
    ...
    if (mysqli_num_rows($res) > 0) {
      ...
      if ($old_password != $row['admin_password']) {
        ...
        $query = "UPDATE m_admin SET  admin_password =? WHERE admin_id =?";
...
<body>
  ...
  <div class="main-content">
    ...
    $ret = "SELECT * FROM  m_admin  WHERE admin_id = '$admin_id'";
