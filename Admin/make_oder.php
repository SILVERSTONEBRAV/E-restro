...
if (isset($_POST['make'])) {
  ...
  if (empty($_POST["order_code"]) || empty($_POST["customer_name"]) || empty($_GET['prod_price'])) {
    ...
    $postQuery = "INSERT INTO m_orders (prod_qty, order_id, order_code, customer_id, customer_name, prod_code, prod_name, prod_price) VALUES(?,?,?,?,?,?,?,?)";
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data">
                ...
                $ret = "SELECT * FROM  m_products WHERE prod_code = '$prod_code'";
                $stmt = $mysqli->prepare($ret);
                $stmt->execute();
                $res = $stmt->get_result();
