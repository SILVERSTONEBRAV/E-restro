...
<head>
    ...
    <meta name="author" content="SilverstoneDevelopers Inc">
    <title>Mealify </title>
    <!-- Favicon -->
                ...
                <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <address>
                                <strong>Mealify Lounge</strong>
                                <br>
                                1726-30200
                                <br>
                                1221 Oginga street, Kitale
                                <br>
                                (+254) 799-296-670
                            </address>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                            ...
                            <p>
                                <em class="text-success">Certified Receipt: <?php echo $order->order_code; ?></em>
                            </p>
                        </div>
                    </div>
                    <div class="row">
