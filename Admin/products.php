...
if (isset($_GET['delete'])) {
  ...
  $adn = "DELETE FROM  m_products  WHERE  prod_id = ?";
                  ...
                  ?>
                    <tr>
                      <td>
                        ...
                        if ($prod->prod_img) {
                          echo "<img src='assets/images/products/$prod->prod_img'>";
                        } else {
                          echo "<img src='assets/images/products/default.jpg'>";
                        }
                      ...
                      <td><del>Ksh. <?php echo $prod->prod_discount; ?></del></td>
                      <td>
